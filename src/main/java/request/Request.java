 ...
 */
public sealed interface Request extends BufferSerializable permits RequestFusionChangeLeader, RequestFusionInit, RequestFusionInitFWD, RequestFusionInitKO, RequestFusionInitOK, RequestFusionRequest, RequestLoginAccepted, RequestLoginAnonymous, RequestLoginPassword, RequestLoginRefused, RequestMessageFilePrivate, RequestMessagePrivate, RequestMessagePublic {
    OpCode getOpCode();
