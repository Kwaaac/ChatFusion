 ...
 */
public sealed interface Request extends BufferSerializable permits RequestFusionInit, RequestLoginAccepted, RequestLoginAnonymous, RequestLoginPassword, RequestMessageFilePrivate, RequestMessagePrivate, RequestMessagePublic {
    OpCode getOpCode();
