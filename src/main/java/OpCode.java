...
import main.java.reader.message.RequestFilePrivateReader;
...
public enum OpCode {
    ...
    MESSAGE(4, new RequestMessagePublicReader()), PRIVATE_MESSAGE(5, new RequestMessagePrivateReader()), FILE_PRIVATE(6, new RequestFilePrivateReader()),
